        ...
        <el-col :span="24">
          <el-card>
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="6">
                <el-button type="warning" icon="el-icon-tickets" @click="$router.push('/instructor/question-bank')">
                  题库管理
                </el-button>
              </el-col>
              <el-col :span="6">
        ...
        <el-col :span="24">
          <el-card>
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="6">
                <el-button type="warning" icon="el-icon-edit" @click="$router.push('/student/quiz-list')">
                  我的测验
                </el-button>
              </el-col>
            </el-row>
